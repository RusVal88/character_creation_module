...
def attack(char_name: str, char_class: str) -> str:
    """Выводит сообщение о том сколько персонаж нанёс урона противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выводит сообщение, сколько персонаж заблокировал атак."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит сообщение о том, какое специальное умение применил персонаж."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывает персонаж и проводит тренировку."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выполняет действие по выбору персонажа."""
    approve_choice = None
    char_class = None
